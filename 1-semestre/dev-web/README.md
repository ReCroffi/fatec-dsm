...
Professor: Rodrigo Attique — FATEC Olímpia/SP, 1º semestre de DSM.

| Pasta | O que é |
|---|---|
| [`aulas/`](aulas/) | Registros das aulas: introdução à Web, HTML, semântica, listas e links, CSS e o exercício de seletores — uma pasta por aula |
